...
import initialState, { initialTokenState, webSocketState } from '../store/initialState';
...
export default function App() {
	...
	const [integrationState, dispatchInt] = useReducer(tokenReducer, initialTokenState);
